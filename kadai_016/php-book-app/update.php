...
if (isset($_POST['submit'])) {
    try {
        ...
        header('Location: read.php?message=更新が完了しました');
        exit();
        ...
        <article class="form">
            ...
            <form action="update.php?id=<?= htmlspecialchars($_GET['id'], ENT_QUOTES, 'UTF-8') ?>" method="post">
                <div>
                    ...
                    <label for="price">単価<span>【必須】</span></label>
                ...
                <button type="submit" name="submit" value="update" class="btn">更新</button>
                <a href="read.php" class="btn back">戻る</a>
            </form>
        </article>
    </main>
